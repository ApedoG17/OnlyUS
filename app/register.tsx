      ...
      >
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.headerBlock}>
            <Text style={styles.subText}>START YOUR JOURNEY</Text>
            <View style={styles.titleRow}>
              <View style={styles.accentLine} />
              <Text style={styles.mainTitle}>Welcome!</Text>
            </View>
            <Text style={styles.descText}>
              Exclusive private access. Connect with your partner securely without the noise of the outside world.
            </Text>
          </View>
          ...
          <View style={styles.glassCard}>
            ...
            <View style={styles.socialRow}>
              ...
              <TouchableOpacity style={styles.socialIcon}><Globe color="#FAFAFA" size={20} /></TouchableOpacity>
              <TouchableOpacity style={styles.socialIcon}><Mail color="#FAFAFA" size={20} /></TouchableOpacity>
            </View>
...
const styles = StyleSheet.create({
  ...
  // Glass Card Layout
  glassCard: {
    backgroundColor: 'rgba(255, 255, 255, 0.08)', // Light frosted look
    borderWidth: 1,
  ...
  input: {
    height: 48,
    backgroundColor: 'rgba(0,0,0,0.2)', // Dark pill inner shadow look
    borderRadius: RADIUS.full,
